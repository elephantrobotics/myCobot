...
void MyCobotBasic::powerOn()
{
	...
	Serial1.write(header);
	Serial1.write(POWER_ON_LEN);
	Serial1.write(POWER_ON);
	Serial1.write(footer);
...
void MyCobotBasic::powerOff()
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(POWER_OFF_LEN);
	Serial1.write(POWER_OFF);
	Serial1.write(footer);
	delay(WRITE_SERVO_GAP);
}
...
bool MyCobotBasic::isPoweredOn()
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(IS_POWERED_ON_LEN);
	Serial1.write(IS_POWERED_ON);
	Serial1.write(footer);
...
int MyCobotBasic::getAtomVersion()
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(GET_SYSTEM_VERSION_LEN);
	Serial1.write(GET_SYSTEM_VERSION);
	Serial1.write(footer);
...
Angles MyCobotBasic::getAngles()
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(GET_ANGLES_LEN);
	Serial1.write(GET_ANGLES);
	Serial1.write(footer);
...
void MyCobotBasic::writeAngle(int joint, float value, int speed)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(WRITE_ANGLE_LEN);
	Serial1.write(WRITE_ANGLE);
	Serial1.write(joint_number);
	Serial1.write(angle_high);
	Serial1.write(angle_low);
	Serial1.write(sp);
	Serial1.write(footer);
...
void MyCobotBasic::writeAngles(Angles angles, int speed)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(WRITE_ANDLES_LEN);
	Serial1.write(WRITE_ANGLES);

	Serial1.write(angle_1_high);
	Serial1.write(angle_1_low);
	Serial1.write(angle_2_high);
	Serial1.write(angle_2_low);
	Serial1.write(angle_3_high);
	Serial1.write(angle_3_low);
	Serial1.write(angle_4_high);
	Serial1.write(angle_4_low);
	Serial1.write(angle_5_high);
	Serial1.write(angle_5_low);
	Serial1.write(angle_6_high);
	Serial1.write(angle_6_low);
...
Coords MyCobotBasic::getCoords()
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(GET_COORDS_LEN);
	Serial1.write(GET_COORDS);
	Serial1.write(footer);
...
void MyCobotBasic::writeCoord(Axis axis, float value, int speed)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(WRITE_COORD_LEN);
	Serial1.write(WRITE_COORD);
	Serial1.write(axis_number);
	Serial1.write(value_high);
	Serial1.write(value_low);
	Serial1.write(sp);
	Serial1.write(footer);
	//delay(WRITE_SERVO_GAP);
...
void MyCobotBasic::writeCoords(Coords coord, int speed)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(WRITE_COORDS_LEN);
	Serial1.write(WRITE_COORDS);
	Serial1.write(coord_x_high);
	Serial1.write(coord_x_low);
	Serial1.write(coord_y_high);
	Serial1.write(coord_y_low);
	Serial1.write(coord_z_high);
	Serial1.write(coord_z_low);
	Serial1.write(coord_rx_high);
	Serial1.write(coord_rx_low);
	Serial1.write(coord_ry_high);
	Serial1.write(coord_ry_low);
	Serial1.write(coord_rz_high);
	Serial1.write(coord_rz_low);
	Serial1.write(sp);
	Serial1.write(mode);
	Serial1.write(footer);
	//delay(WRITE_SERVO_GAP);
...
int MyCobotBasic::isInPosition(Coords coord, bool is_linear)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(IS_IN_POSITION_LEN);
	Serial1.write(IS_IN_POSITION);
	Serial1.write(coord_x_high);
	Serial1.write(coord_x_low);
	Serial1.write(coord_y_high);
	Serial1.write(coord_y_low);
...
bool MyCobotBasic::checkRunning()
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(CHECK_RUNNING_LEN);
	Serial1.write(CHECK_RUNNING);
	Serial1.write(footer);
...
void MyCobotBasic::jogAngle(int joint, int direction, int speed)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(JOG_ANGLE_LEN);
	Serial1.write(JOG_ANGLE);
	Serial1.write(joint_number);
	Serial1.write(di);
	Serial1.write(sp);
	Serial1.write(footer);
...
void MyCobotBasic::jogCoord(Axis axis, int direction, int speed)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(JOG_COORD_LEN);
	Serial1.write(JOG_COORD);
	Serial1.write(axis_number);
	Serial1.write(di);
	Serial1.write(sp);
	Serial1.write(footer);
...
void MyCobotBasic::jogStop()
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(JOG_STOP_LEN);
	Serial1.write(JOG_STOP);
	Serial1.write(footer);
}
...
void MyCobotBasic::setEncoder(int joint, int encoder)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(SET_ENCODER_LEN);
	Serial1.write(SET_ENCODER);
	Serial1.write(joint_number);
	Serial1.write(encoder_high);
	Serial1.write(encoder_low);
	Serial1.write(footer);
}
...
int MyCobotBasic::getEncoder(int joint)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(GET_ENCODER_LEN);
	Serial1.write(GET_ENCODER);
	Serial1.write(joint_number);
	Serial1.write(footer);
...
Angles MyCobotBasic::getEncoders()
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(GET_ENCODERS_LEN);
...
void MyCobotBasic::setEncoders(Angles angleEncoders, int speed)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(SET_ENCODERS_LEN);
	Serial1.write(SET_ENCODERS);
	Serial1.write(angle_1_high);
	Serial1.write(angle_1_low);
	Serial1.write(angle_2_high);
	Serial1.write(angle_2_low);
...
int MyCobotBasic::getSpeed()
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(GET_SPEED_LEN);
	Serial1.write(GET_SPEED);
	Serial1.write(footer);
...
void MyCobotBasic::setSpeed(int percentage)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(SET_SPEED_LEN);
	Serial1.write(SET_SPEED);
	Serial1.write(speed);
	Serial1.write(footer);
}
...
float MyCobotBasic::getFeedOverride()
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(GET_FEED_OVERRIDE_LEN);
	Serial1.write(GET_FEED_OVERRIDE);
	Serial1.write(footer);
...
void MyCobotBasic::sendFeedOverride(float feed_override)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(SEND_OVERRIDE_LEN);
	Serial1.write(SEND_OVERRIDE);
	Serial1.write(feed_override_high);
	Serial1.write(feed_override_low);
	Serial1.write(footer);
}
...
float MyCobotBasic::getAcceleration()
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(GET_ACCELERATION_LEN);
	Serial1.write(GET_ACCELERATION);
	Serial1.write(footer);
...
void MyCobotBasic::setAcceleration(float acceleration)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(SET_ACCELERATION_LEN);
	Serial1.write(SET_ACCELERATION);
	Serial1.write(acceleration_high);
	Serial1.write(acceleration_low);
	Serial1.write(footer);
}
...
float MyCobotBasic::getJointMin(int joint)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(GET_JOINT_MIN_LEN);
	Serial1.write(GET_JOINT_MIN);
	Serial1.write(joint_number);
	Serial1.write(footer);
...
float MyCobotBasic::getJointMax(int joint)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(GET_JOINT_MAX_LEN);
	Serial1.write(GET_JOINT_MAX);
	Serial1.write(joint_number);
	Serial1.write(footer);
...
void MyCobotBasic::setJointMin(int joint, float angle)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(SET_JOINT_MIN_LEN);
	Serial1.write(SET_JOINT_MIN);
	Serial1.write(joint_number);
	Serial1.write(angle_high);
	Serial1.write(angle_low);
	Serial1.write(footer);
...
void MyCobotBasic::setJointMax(int joint, float angle)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(SET_JOINT_MAX_LEN);
	Serial1.write(SET_JOINT_MAX);
	Serial1.write(joint_number);
	Serial1.write(angle_high);
	Serial1.write(angle_low);
	Serial1.write(footer);
...
bool MyCobotBasic::isServoEnabled(int joint)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(IS_SERVO_ENABLED_LEN);
	Serial1.write(IS_SERVO_ENABLED);
	Serial1.write(joint_number);
	Serial1.write(footer);
...
bool MyCobotBasic::isAllServoEnabled()
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(IS_ALL_SERVO_ENABLED_LEN);
	Serial1.write(IS_ALL_SERVO_ENABLED);
	Serial1.write(footer);
...
byte MyCobotBasic::getServoData(int joint, byte data_id)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(GET_SERVO_DATA_LEN);
	Serial1.write(GET_SERVO_DATA);
	Serial1.write(joint_number);
	Serial1.write(data_id);
	Serial1.write(footer);
...
void MyCobotBasic::setServoCalibration(int joint)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(SET_SERVO_CALIBRATION_LEN);
	Serial1.write(SET_SERVO_CALIBRATION);
	Serial1.write(joint_number);
	Serial1.write(footer);
}
...
void MyCobotBasic::setPinMode(byte pin_no, byte pin_mode)
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(SET_PIN_MODE_LEN);
	Serial1.write(SET_PIN_MODE);
	Serial1.write(pin_no);
	Serial1.write(pin_mode);
	Serial1.write(footer);
}
...
void MyCobotBasic::pause()
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(PROGRAM_PAUSE_LEN);
	Serial1.write(PROGRAM_PAUSE);
	Serial1.write(footer);
}
...
void MyCobotBasic::resume()
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(PROGRAM_RESUME_LEN);
	Serial1.write(PROGRAM_RESUME);
	Serial1.write(footer);
}
...
void MyCobotBasic::stop()
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(TASK_STOP_LEN);
	Serial1.write(TASK_STOP);
	Serial1.write(footer);
}
...
void MyCobotBasic::setLEDRGB(byte r, byte g, byte b)
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(SET_LED_LEN);
	Serial1.write(SET_LED);
	Serial1.write(r);
	Serial1.write(g);
	Serial1.write(b);
	Serial1.write(footer);
...
void MyCobotBasic::setGripper(int data)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(SET_GRIPPER_STATE_LEN);
	Serial1.write(SET_GRIPPER_STATE);
	Serial1.write(gripper_data);
	Serial1.write(footer);
}
...
void MyCobotBasic::setServoData(byte servo_no, byte servo_state, byte servo_data)
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(SET_SERVO_DATA_LEN);
	Serial1.write(SET_SERVO_DATA);

	Serial1.write(servo_no);
	Serial1.write(servo_state);
	Serial1.write(servo_data);
	Serial1.write(footer);
}
...
void MyCobotBasic::setFreeMove()
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(SET_FREE_MOVE_LEN);
	Serial1.write(SET_FREE_MOVE);
	Serial1.write(footer);
}
...
void MyCobotBasic::setMovementType(MovementType movement_type)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(SET_MOVEMENT_TYPE_LEN);
	Serial1.write(SET_MOVEMENT_TYPE);
	Serial1.write(mt);
	Serial1.write(footer);
}
...
MovementType MyCobotBasic::getMovementType()
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(GET_MOVEMENT_TYPE_LEN);
	Serial1.write(GET_MOVEMENT_TYPE);
	Serial1.write(footer);
...
void MyCobotBasic::setToolReference(Coords coord)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(SET_TOOL_REF_LEN);
	Serial1.write(SET_TOOL_REF);
	Serial1.write(coord_x_high);
	Serial1.write(coord_x_low);
	Serial1.write(coord_y_high);
	Serial1.write(coord_y_low);
...
void MyCobotBasic::setWorldReference(Coords coord)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(SET_WORLD_REF_LEN);
	Serial1.write(SET_WORLD_REF);
	Serial1.write(coord_x_high);
	Serial1.write(coord_x_low);
	Serial1.write(coord_y_high);
	Serial1.write(coord_y_low);
...
Coords MyCobotBasic::getToolReference()
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(GET_TOOL_REF_LEN);
	Serial1.write(GET_TOOL_REF);
	Serial1.write(footer);
...
Coords MyCobotBasic::getWorldReference()
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(GET_WORLD_REF_LEN);
	Serial1.write(GET_WORLD_REF);
	Serial1.write(footer);
...
void MyCobotBasic::setReferenceFrame(RFType rftype)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(SET_REF_FRAME_LEN);
	Serial1.write(SET_REF_FRAME);
	Serial1.write(rt);
	Serial1.write(footer);
}
...
RFType MyCobotBasic::getReferenceFrame()
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(GET_REF_FRAME_LEN);
	Serial1.write(GET_REF_FRAME);
	Serial1.write(footer);
...
void MyCobotBasic::setEndType(EndType end_type)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(SET_END_TYPE_LEN);
	Serial1.write(SET_END_TYPE);
	Serial1.write(et);
	Serial1.write(footer);
}
...
EndType MyCobotBasic::getEndType()
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(GET_END_TYPE_LEN);
	Serial1.write(GET_END_TYPE);
	Serial1.write(footer);
...
void MyCobotBasic::setDigitalOutput(byte pin_no, byte pin_state)
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(SET_DIGITAL_OUTPUT_LEN);
	Serial1.write(SET_DIGITAL_OUTPUT);
	Serial1.write(pin_no);
	Serial1.write(pin_state);
	Serial1.write(footer);
}
...
int MyCobotBasic::getDigitalInput(byte pin_no)
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(GET_DIGITAL_INPUT_LEN);
	Serial1.write(GET_DIGITAL_INPUT);
	Serial1.write(pin_no);
	Serial1.write(footer);
...
void MyCobotBasic::setPWMMode(int freq, byte pin_no, byte channel)
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(SET_PWM_MODE_LEN);
	Serial1.write(SET_PWM_MODE);


	byte freq_high = highByte(freq);
	byte freq_low = lowByte(freq);

	Serial1.write(freq_high);
	Serial1.write(freqa_low);
...
void MyCobotBasic::setPWMOutput(byte pin_no, int freq,  byte pin_write)
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(SET_PWM_OUTPUT_LEN);
	Serial1.write(SET_PWM_OUTPUT);
	Serial1.write(pin_no);
	...
	Serial1.write(freq_high);
	Serial1.write(freq_low);


	Serial1.write(pin_write);
	Serial1.write(footer);
}
...
void MyCobotBasic::releaseServo(byte servo_no)
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(RELEASE_SERVO_LEN);
	Serial1.write(RELEASE_SERVO);
	Serial1.write(servo_no);
	Serial1.write(footer);
}
...
void MyCobotBasic::focusServo(byte servo_no)
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(FOCUS_SERVO_LEN);
	Serial1.write(FOCUS_SERVO);
	Serial1.write(servo_no);
	Serial1.write(footer);
}
...
void MyCobotBasic::setGripperValue(int data, int sp)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(SET_GRIPPER_VALUE_LEN);
	Serial1.write(SET_GRIPPER_VALUE);
	Serial1.write(data);
	Serial1.write(sp);
	Serial1.write(footer);
}
...
void MyCobotBasic::setGripperIni()
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(SET_GRIPPER_INI_LEN);
	Serial1.write(SET_GRIPPER_INI);
	Serial1.write(footer);
}
...
int MyCobotBasic::getGripperValue()
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(GET_GRIPPER_VALUE_LEN);
	Serial1.write(GET_GRIPPER_VALUE);
	Serial1.write(footer);
...
bool MyCobotBasic::isGripperMoving()
{
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(IS_GRIPPER_MOVING_LEN);
	Serial1.write(IS_GRIPPER_MOVING);
	Serial1.write(footer);
...
void MyCobotBasic::moveCCoords(Coords begin_coord, Coords middle_coord, Coords end_coord)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(MOVEC_COORDS_DEFAULT_LEN);
	Serial1.write(MOVEC_COORDS_DEFAULT);
	Serial1.write(begin_x_high);
	Serial1.write(begin_x_low);
	Serial1.write(begin_y_high);
	Serial1.write(begin_y_low);
	Serial1.write(begin_z_high);
	Serial1.write(begin_z_low);
	Serial1.write(begin_rx_high);
	Serial1.write(begin_rx_low);
	Serial1.write(begin_ry_high);
	Serial1.write(begin_ry_low);
	Serial1.write(begin_rz_high);
	Serial1.write(begin_rz_low);
	Serial1.write(middle_x_high);
	Serial1.write(middle_x_low);
	Serial1.write(middle_y_high);
	Serial1.write(middle_y_low);
	Serial1.write(middle_z_high);
	Serial1.write(middle_z_low);
	Serial1.write(middle_rx_high);
	Serial1.write(middle_rx_low);
	Serial1.write(middle_ry_high);
	Serial1.write(middle_ry_low);
	Serial1.write(middle_rz_high);
	Serial1.write(middle_rz_low);
	Serial1.write(end_x_high);
	Serial1.write(end_x_low);
	Serial1.write(end_y_high);
	Serial1.write(end_y_low);
	Serial1.write(end_z_high);
	Serial1.write(end_z_low);
	Serial1.write(end_rx_high);
	Serial1.write(end_rx_low);
	Serial1.write(end_ry_high);
	Serial1.write(end_ry_low);
	Serial1.write(end_rz_high);
	Serial1.write(end_rz_low);
	Serial1.write(footer);
}
...
void MyCobotBasic::moveCCoords(Coords middle_coord, Coords end_coord)
{
	...
	Serial1.write(header);
	Serial1.write(header);
	Serial1.write(MOVEC_COORDS_LEN);
	Serial1.write(MOVEC_COORDS);
	Serial1.write(middle_x_high);
	Serial1.write(middle_x_low);
	Serial1.write(middle_y_high);
	Serial1.write(middle_y_low);
